...
# Stub ai_scraper to avoid browser dependencies during unit tests.
...
class TestExecutionPaths(unittest.TestCase):
    def test_end_to_end_project_root_write_location(self):
        ...
        # Simula resultado de `ng new demo-app`.
        ...
        # No debe aparecer archivo suelto en raíz de workspace.
